...
We accept bug reports via issues created on [Github](https://github.com/meekframework/http/issues).
...
- **Always try the [master branch](https://github.com/meekframework/http)** - to see if the reported bug has not already been fixed.
...
We accept contributions via Pull Requests on [Github](https://github.com/meekframework/http/pull).
...
- **Document any change in behaviour** - Make sure the [README.md](https://github.com/meekframework/http/README.md) and any other relevant documentation are kept up-to-date.
